...
@Service(value = "FilesStorageServiceImplReview")
public class FilesStorageServiceImplReview implements FilesStorageServiceUser {

	// private Path root = Paths.get("c:\\upload/test");
	@Value("${review_img.dir}")
	private Path root;

	public FilesStorageServiceImplReview() throws Exception {
